...
- 💻 **프론트엔드 개발자 꿈나무**, 성장 중입니다!
- 🌱 요즘은 **React / Next.js / TypeScript**에 집중하고 있어요.
- 🌍 **세상을 따뜻하게 연결하는 서비스**를 만드는 게 꿈이에요.
- ✨ 관심 분야: 창의적이고 감성적인 웹 서비스 기획 & 개발
...
| 프로젝트명 | 설명 | 링크 | 배포 링크 |
|------------|------|------|------|
| 🏎️ AfterLap | F1 일정 확인 어플리케이션 | [🔗 GitHub](https://github.com/ysnam0123/AfterLap) | [🔗 링크](https://afterlap.vercel.app/) |
| 🏆 Routie | Next.js 를 이용한 루틴 관리 어플리케이션 | [🔗 GitHub](https://github.com/ysnam0123/routie) |
| 🎁 TravelMate | 기간을 선택하면 여행장소를 추천해주는 앱 | [🔗 GitHub](https://github.com/ysnam0123/TravelMate) |
| 📰 NewsDocs | Vue + Supabase로 만든 뉴스 카드 서비스 | [🔗 GitHub](https://github.com/ysnam0123/NewsDocs) |
